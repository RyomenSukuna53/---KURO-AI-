...
SUPPORT_CHANNEL_LINK = getenv("SCL", "t.me/COLXproMainChannel") 
SUPPORT_CHANNEL_ID = int(getenv("SCI", -1002182715527)) 
SUPPORT_GROUP_LINK = getenv("SGL", "t.me/COL_Xpro_main") 
SUPPORT_GROUP_ID = int(getenv("SGI", -1002447932848)) 
SUDO_USERS = [7019600964, 6239769036, 1514849521]
